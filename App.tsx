...
const Aplicación: React.FC = () => {
  ...
  const scrollToSection = (id: string) => {
    // Si estabas en FORM/SESSION, primero vuelve a HOME para que existan esas secciones
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-50">
      ...
      <main>
        ...
        {state === AppState.HOME && (
          <>
            {/* HERO (sin botón “Comenzar sesión”) */}
                ...
                <div className="grid md:grid-cols-2 gap-12 text-left">
                  <div className="space-y-4">
                    ...
                    <p className="text-slate-400 leading-relaxed">
                      Tu cerebro no es estático. Es maleable. A través de la
                      hipnosis clínica, accedemos a estados de ondas Theta donde
                      la mente es receptiva a nuevas instrucciones de alto
                      nivel.
                    </p>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-slate-400 leading-relaxed">
                      No usamos afirmaciones genéricas. Utilizamos comandos
                      lingüísticos precisos que eluden la mente crítica para
                      instalar creencias de alto valor directamente en tu
                      subconsciente.
                    </p>
                  </div>
                </div>
            ...
            <footer
              id="about"
              className="py-24 px-6 border-t border-slate-900 bg-slate-950"
            >
              <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                ...
                <div>
                  ...
                  <p className="text-slate-400 mb-6 leading-relaxed">
                    Facilitadora de procesos de transformación humana,
                    especializada en Hipnosis Clínica y Breathwork. Mi misión es
                    demostrarte que los límites de tu vida no están en el mundo
                    exterior, sino en la programación de tu subconsciente.
                  </p>

                  <p className="text-slate-400 mb-8 leading-relaxed">
                    Formada en los principios de la neurobiología del cambio del
                    Dr. Joe Dispenza y la epigenética de Bruce Lipton, he
                    perfeccionado un método diseñado para mujeres que saben que
                    hay "algo más" y buscan recablear su mente para sanar sus
                    relaciones y reclamar su libertad. Mi acompañamiento es como
                    mi método: Rápido, Directo e Inevitable.
                  </p>
            ...
            <section className="py-28 px-6 bg-slate-950 border-t border-white/5">
